        ...
        <div class="chart-wrapper">
          ...
          <div style="height:470px; margin-top:20px">
            <el-form :model="form" label-width="80px">
              ...
              <el-form-item>
                <div style="margin-right:20px"><el-button type="success" @click="playVideo()">开启预览</el-button></div>
                <div><el-button type="primary" @click="formSubmit()">提交配置</el-button></div>
              </el-form-item>
            </el-form>
          </div>
        </div>
...
import { wsPlayer } from './wsplayer/wsPlayer.js'; // 引入 wsPlayer.js 路径
